...
# We have to hink about whether adding these two classes.
...
# Having too many variables can cause some drawbacks, such as multicollinearity. 
# It is beyond our coverage. 
...
```{r creating a train set and a test set}
